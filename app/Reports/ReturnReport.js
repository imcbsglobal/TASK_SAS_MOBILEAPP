...
export default function ReturnReportScreen() {
  ...
  const fetchReport = async () => {
    try {
      ...
      } catch (e) { console.log('[ReturnReport] Fetch error:', e); }
        ...
        <View style={styles.section}>
          ...
          {Object.keys(data.customers).length > 0 ? (
            ...
            <View style={styles.emptyState}>
              <Ionicons name="return-up-back-outline" size={48} color={Colors.neutral[300]} />
              <Text style={styles.emptyText}>No returns recorded today</Text>
            </View>
          )}
        </View>
      </ScrollView>
...
const styles = StyleSheet.create({
  ...
  avatar: { width: 36, height: 36, borderRadius: 18, backgroundColor: Colors.primary[50], justifyContent: 'center', alignItems: 'center', marginRight: 12 },
  avatarText: { color: Colors.primary.main, fontWeight: '700', fontSize: 14 },
  ...
  badge: { backgroundColor: Colors.primary[50], paddingHorizontal: 10, paddingVertical: 4, borderRadius: BorderRadius.full },
  badgeText: { color: Colors.primary.main, fontSize: 12, fontWeight: '700' },
