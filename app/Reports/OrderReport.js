...
export default function OrderReportScreen() {
  ...
  return (
    <View style={styles.container}>
      ...
      {/* Premium Header with iOS Shadow Fix */}
      ...
      >
        {/* KPI Dashboard with Shadow Wrappers */}
        ...
        {Object.keys(data.customers).length > 0 ? (
              ...
              >
                <View style={styles.customerHeader}>
                  ...
                  <View style={styles.customerInfo}>
                    ...
                    <Text style={styles.orderCount}>{stats.count} {stats.count === 1 ? 'Order' : 'Orders'}</Text>
                  </View>
          ...
          <View style={styles.emptyContainer}>
            ...
            <Text style={styles.emptySubtitle}>
              There are no orders recorded for {selectedDay === 'today' ? 'today' : 'yesterday'}.
            </Text>
          </View>
        )}
