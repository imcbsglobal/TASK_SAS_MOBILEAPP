...
export default function OrderReportScreen() {
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      >
        <LinearGradient colors={[Colors.secondary.main, Colors.secondary[700] || '#6366f1']} style={styles.summaryCard}>
        ...
        <View style={styles.section}>
          ...
          {Object.keys(data.customers).length > 0 ? (
            ...
            <View style={styles.emptyState}>
              <Ionicons name="receipt-outline" size={48} color={Colors.neutral?.[300] || '#CBD5E1'} />
              <Text style={styles.emptyText}>No orders for {selectedDay === 'today' ? 'today' : 'yesterday'}</Text>
            </View>
          )}
        </View>
      </ScrollView>
...
const styles = StyleSheet.create({
  ...
  avatar: { width: 36, height: 36, borderRadius: 18, backgroundColor: Colors.secondary?.[50] || '#EEF2FF', justifyContent: 'center', alignItems: 'center', marginRight: 12 },
  ...
  badge: { backgroundColor: Colors.secondary?.[50] || '#EEF2FF', paddingHorizontal: 10, paddingVertical: 4, borderRadius: BorderRadius.full },
