...
export default function SalesReportScreen() {
  ...
  const fetchReport = async () => {
    try {
      ...
      } catch (e) { console.log('[SalesReport] Fetch error:', e); }
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      >
        <LinearGradient
          colors={[Colors.success.main, Colors.success[700]]}
...
const styles = StyleSheet.create({
  ...
  avatar: { width: 36, height: 36, borderRadius: 18, backgroundColor: Colors.success[50], justifyContent: 'center', alignItems: 'center', marginRight: 12 },
  avatarText: { color: Colors.success.main, fontWeight: '700', fontSize: 14 },
  ...
  badge: { backgroundColor: Colors.success[50], paddingHorizontal: 10, paddingVertical: 4, borderRadius: BorderRadius.full },
  badgeText: { color: Colors.success.main, fontSize: 12, fontWeight: '700' },
