  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={[styles.header, { paddingTop: insets.top }]}>
        ...
        <TouchableOpacity onPress={fetchReport} style={styles.backButton}>
          {loading
            ...
            : <Ionicons name="refresh" size={24} color={Colors.success.main} />}
        </TouchableOpacity>
      </View>
      ...
      <ScrollView
        ...
        refreshControl={<RefreshControl refreshing={loading} onRefresh={fetchReport} colors={[Colors.success.main]} />}
      >
        <LinearGradient colors={[Colors.success.main, Colors.success[700] || '#15803d']} style={styles.summaryCard}>
            ...
            Object.entries(data.customers).map(([name, stats], index) => (
              <View key={index} style={styles.customerItem}>
                ...
                <View style={styles.badge}>
                  <Text style={styles.badgeText}>{stats.count} Sales</Text>
                </View>
              </View>
            ))
          ) : (
            <View style={styles.emptyState}>
              <Ionicons name="cart-outline" size={48} color={Colors.neutral?.[300] || '#CBD5E1'} />
              <Text style={styles.emptyText}>No sales for {selectedDay === 'today' ? 'today' : 'yesterday'}</Text>
            </View>
          )}
        </View>
      </ScrollView>
...
const ACCENT = Colors.success.main;
const styles = StyleSheet.create({
  ...
  avatar: { width: 36, height: 36, borderRadius: 18, backgroundColor: Colors.success?.[50] || '#f0fdf4', justifyContent: 'center', alignItems: 'center', marginRight: 12 },
  ...
  badge: { backgroundColor: Colors.success?.[50] || '#f0fdf4', paddingHorizontal: 10, paddingVertical: 4, borderRadius: BorderRadius.full },
