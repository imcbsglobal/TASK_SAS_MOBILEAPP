            ...
            <View style={{ marginTop: 15, flexDirection: 'row', gap: 8, flexWrap: 'wrap', alignItems: 'center' }}>
              <TouchableOpacity
                style={{
                  ...
                  height: 44,
                  borderRadius: 22,
                  backgroundColor: openMenus[order.id] ? Colors.success.main : Colors.neutral[100],
                  alignItems: 'center',
                  justifyContent: 'center',
                  borderWidth: 1,
                  borderColor: openMenus[order.id] ? Colors.success.main : Colors.border.light,
                  ...Shadows.sm
                }}
                onPress={() => setOpenMenus(prev => ({ ...prev, [order.id]: !prev[order.id] }))}
              >
                <Ionicons name="share-social-outline" size={22} color={openMenus[order.id] ? "#fff" : Colors.success.main} />
              </TouchableOpacity>
